...
# Upstream: lib/functions.zsh
# Local changes: subset only. Kept zsh_stats, take*, default, env_default and
#   omz_urlencode. Dropped uninstall_oh_my_zsh, upgrade_oh_my_zsh, open_command,
#   alias_value, try_alias_value and omz_urldecode -- all were only reachable
#   from oh-my-zsh internals or from plugins we no longer load.
#
